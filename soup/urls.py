...
urlpatterns = patterns('',
    ...
    url(r'^apostrophe/?$', 'listings.views.show_soup_multibranch', {'which':'apostrophe', 'tomorrow':False}, name='n_apostrophe_today'),
    url(r'^benugo/?$', 'listings.views.show_soup_multibranch', {'which':'benugo', 'tomorrow':False}, name='n_benugo_today'),
